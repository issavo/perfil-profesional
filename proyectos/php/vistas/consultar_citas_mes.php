...
<div class="content-wrapper">
 <!-- Content Header (Page header) -->
  <section class="content-header">
    <h1>Consulta de Citas por mes</h1>
  </section>
  <!-- Main content -->
      ...
      <div class="col-xs-12">
        <div class="table-responsive">
          <div class="box-header">
            <h3 class="box-title">Listado de Citas por mes</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="citas_mes_data" class="table table-bordered table-striped">
              <thead>
