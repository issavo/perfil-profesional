      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <table id="citas_cliente_data" class="table table-responsive table-bordered table-striped text-center">
              <thead>
                <tr>
                  <th>Nº cita</th>
                  <th>Nombres</th>
            ...
            <input type="hidden" name="cliente" id="cliente" value="<?php echo $_SESSION["usuario"]; ?>">
          </div>
          <!-- /.box-body -->
        </div>
        <!-- /.box -->
...
<div class="modal fade" id="citaModal">
  <div class="modal-dialog">
    <div class="content-wrapper text-center" style="width: 1000px; margin-left: -0px">
                  ...
                  <div class="box" style="padding: 10px;">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-9">
                          <input type="text" class="form-control" id="nombre" name="nombre" value="" disabled required>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-lg-9">
                          <input type="text" class="form-control" id="apellidos" name="apellidos" value="" disabled required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-9">
                          <input type="text" class="form-control" id="telefono" name="telefono" value="" disabled required />
                        </div>
                      </div>
                      <div class="form-group">
